...
if (isset($_GET['status']) && $_GET['status'] == 'success') {
    ...
    echo "<script>alert('Success: Examination submitted.');</script>";
}
?>
  ...
  <div class="card shadow-sm">
    <div class="card-header border-bottom bg-primary text-white">
      <h5 class="mb-0">Mailing Examination Form</h5>
    </div>
      ...
      <form  enctype="multipart/form-data" method="POST" action="process.php">
        <div class="row">
          ...
          <div class="col-md-12 mb-3">
            <label for="link_share" class="form-label">Shareable Link</label>
            <input type="url" class="form-control" id="link_share" name="link_share" placeholder="Enter shareable link">
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea name="messageHtml" id="messageHtml" class="form-control" rows="4" required></textarea>
        </div>
